...
/**
 * k6 options for ListReader.Api login load testing.
 *
 * Purpose:
 * - Measure ListReader.Api authentication endpoint under baseline local load.
 */
 ...
 *
 * Each iteration:
 * - sends a login request to ListReader.Api
 * - validates HTTP 200
...
export default function () {
    ...
    checkLoginResponse(response, 'ListReader login load');
...
export function handleSummary(data) {
    return createCsvSummaryOutputs(data, 'listreader-login-load');
}
